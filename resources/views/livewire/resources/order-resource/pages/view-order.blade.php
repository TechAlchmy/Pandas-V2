        ...
        <div class="max-w-3xl mx-auto">
            <div class="space-y-6">
                <div class="flex gap-4 text-sm">
                    <span>Orders</span>
                    @svg('heroicon-o-arrow-right', 'w-5 h-5 text-gray-600')
                    ...
                    <div class="px-4 py-6 sm:px-6 lg:grid lg:grid-cols-12 lg:gap-x-8 lg:p-8">
                        <div class="sm:flex lg:col-span-7">
                            ...
                            <div class="mt-6 sm:ml-6 sm:mt-0">
                                ...
                                <p class="mt-3 text-sm text-gray-500">This durable and portable insulated tumbler will
                                    keep your beverage at the perfect temperature during your next adventure.</p>
                            </div>
                        </div>
