                        ...
                        <div class="flex gap-6 items-center">
                            <div class="w-full">
                                <div class="flex items-center space-x-1 w-full">
                                    <span>$</span>
                                    <x-input class="max-w-[10rem] w-full !border-solid border-black p-2" type="number" wire:model="amount" placeholder="Enter amount..." :min="$this->record->bh_min / 100" :max="$this->record->bh_max / 100" />
                                </div>
