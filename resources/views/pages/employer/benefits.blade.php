...
<x-layouts.app for-employer>
        ...
        <div class="grid grid-cols-1 gap-2 lg:grid-cols-2" x-data="{ activeAccordion: 0 }">
            ...
            <div class="p-8 space-y-6">
                <h2 class="text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl font-editorial">
                    Benefits for<br />Life Essentials
                </h2>
                <p class="lg:max-w-xs">
    ...
    <section class="px-[min(6.99vw,50px)] py-8 bg-neutral-200 xl:-mt-40">
        <x-hr />
        <div class="max-w-[1920px] mx-auto">
            <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
                <div class="lg:col-span-2" x-data="{ shown: false }" x-intersect.once="shown = true">
                    <h2 x-show="shown" x-transition.duration.2000 class="hidden lg:block text-3xl md:text-4xl lg:text-6xl xl:text-7xl 2xl:text-8xl md:col-span-2 font-editorial">
